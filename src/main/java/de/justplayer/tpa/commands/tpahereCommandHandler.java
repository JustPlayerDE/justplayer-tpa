...
public class tpahereCommandHandler implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length != 1) {
            player.sendMessage(plugin.config.getString("messages.prefix") + "Usage: /tpahere <player>");
            return true;
        }
        ...
        target.sendMessage(plugin.config.getString("messages.prefix") + "Warning: If you accept this request, you will be teleported to " + player.getName());
